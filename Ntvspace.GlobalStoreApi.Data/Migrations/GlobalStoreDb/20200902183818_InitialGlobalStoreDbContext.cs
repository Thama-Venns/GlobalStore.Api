...
namespace Ntvspace.GlobalStoreApi.Data.Migrations.GlobalStoreDb
{
    public partial class InitialGlobalStoreDbContext : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CompanyClassifications", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TimeZoneUtc = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MerchantClassificationId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Merchants", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Merchants_CompanyClassifications_MerchantClassificationId",
                        column: x => x.MerchantClassificationId,
                        principalTable: "CompanyClassifications",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CountryBorders", x => new { x.CountryId, x.BorderId });
                    table.ForeignKey(
                        name: "FK_CountryBorders_Borders_BorderId",
                        column: x => x.BorderId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PreviousPayment = table.Column<DateTime>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CountryTimeZones", x => new { x.CountryId, x.TimeZoneId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Creditors_Accounts_AccountId",
                        column: x => x.AccountId,
                        principalTable: "Accounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Creditors_Countries_CountryId",
                        column: x => x.CountryId,
                        principalTable: "Countries",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Pricing", x => new { x.ProductId, x.CurrencyId });
                    table.ForeignKey(
                        name: "FK_Pricing_Currencies_CurrencyId",
                        column: x => x.CurrencyId,
                        principalTable: "Currencies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CountryBorders_BorderId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Creditors_AccountId",
                table: "Creditors",
                column: "AccountId");

            migrationBuilder.CreateIndex(
                name: "IX_Creditors_CountryId",
                table: "Creditors",
                column: "CountryId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Merchants_MerchantClassificationId",
                table: "Merchants",
                column: "MerchantClassificationId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TimeZones_TimeZoneUtc",
                table: "TimeZones",
                column: "TimeZoneUtc",
                unique: true,
                filter: "[TimeZoneUtc] IS NOT NULL");
        }
